    ...
    <section className="relative min-h-screen flex flex-col items-center justify-center px-4 text-center">
      ...
      <div className="max-w-4xl mx-auto pt-24">
        ...
        <div className="badge-pill mb-8 mx-auto w-fit">
          ...
          <span>Built for visionary travel agencies, TMCs, and tour creators</span>
        </div>

        {/* Main Headline */}
        <h1 className="text-5xl md:text-7xl font-bold mb-4">
          <div className="mb-2">KLYP Workbench</div>
          <div className="text-gradient">The Future of Travel</div>
        </h1>

        {/* Subheadline */}
        <p className="text-xl md:text-2xl text-gray-600 mb-8 max-w-3xl mx-auto leading-relaxed">
          Digitalize the chaos of servicing, and plug into a GenAI‑native universal ERP—without writing a line of code.
        </p>
        ...
        <div className="inline-flex items-center px-4 py-2 rounded-full bg-blue-50 text-blue-700 text-sm font-medium">
          Early Access: Starting from just $99/month
        </div>
      </div>
